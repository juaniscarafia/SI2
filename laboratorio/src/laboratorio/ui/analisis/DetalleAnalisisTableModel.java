...
public class DetalleAnalisisTableModel extends AbstractTableModel{
    private final String[] nombresColumnas = {"Código", "Descripción", "Autorizado", "Terminado", "Codigo Muestra", 
        "Bioquímico", "Código Reseta","Tipo"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
          if(rowIndex >= 0 && rowIndex < this.analisis.size()){
            ...
            switch(columnIndex){
                ...
                case 4: return this.analisis.get(rowIndex).getMuestras();
                case 5: return this.analisis.get(rowIndex).getBioquimicos();
                case 6: return this.analisis.get(rowIndex).getReceta();
                case 7: return this.analisis.get(rowIndex).getTipoanalisis();   
                default: return null;
             }
        }else{
            return null;
